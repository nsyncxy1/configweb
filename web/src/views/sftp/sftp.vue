                            ...
                            'data': function (obj, callback) {
                                const res = {
                                    ...
                                    "data": [
                                        ...
                                        {
                                            "id": "/read-file-0.0.1-SNAPSHOT.jar",
                                            "parent": "/",
                                            "text": "read-file-0.0.1-SNAPSHOT.jar",
                                            "icon": "jstree-file",
                                            "fileType": "普通文件",
                                            "fileAttr": "rw-r--r--",
                                            "numberOfDir": "1",
